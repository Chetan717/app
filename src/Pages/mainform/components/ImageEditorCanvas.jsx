        ...
        <div className="flex dark:bg-black w-full flex-col items-center gap-4 p-3">
            <div className="relative dark:bg-white rounded-lg select-none p-2">
                <div className="flex flex-wrap mb-2 justify-center gap-4">
                    <button onClick={() => setRotation((r) => r - 90)} className="p-3 dark:text-black py-1.5 rounded-lg bg-slate-200 hover:bg-slate-200 text-sm font-medium transition">↺ <span></span></button>
                    {/* <button onClick={() => setRotation((r) => r + 90)} className="p-3 py-1.5 rounded-lg bg-slate-200 hover:bg-slate-200 text-sm font-medium transition">↻ +90°</button> */}
                    ...
                    <button onClick={() => setCrop({ x: 0.1, y: 0.1, w: 0.8, h: 0.8 })} className="px-3 dark:text-black py-1.5 rounded-lg bg-slate-200 hover:bg-slate-200 text-sm font-medium transition">Reset</button>
                </div>
                <canvas
                    ref={displayRef}
